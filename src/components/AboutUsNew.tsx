    ...
    <>
      ...
      <PageContainer background="white" padding="lg">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <Card className="p-12 border-0 shadow-2xl bg-gradient-to-br from-red-50 to-pink-50 hover:shadow-3xl transition-shadow">
            <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-pink-500 rounded-2xl flex items-center justify-center mb-8">
              <Target className="h-10 w-10 text-white" />
            </div>
            <h3 className="text-3xl font-black text-gray-900 mb-6 font-poppins">Our Mission</h3>
          ...
          <Card className="p-12 border-0 shadow-2xl bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-3xl transition-shadow">
            <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-8">
              <Globe className="h-10 w-10 text-white" />
            </div>
            <h3 className="text-3xl font-black text-gray-900 mb-6 font-poppins">Our Vision</h3>
            <p className="text-lg text-gray-700 leading-relaxed mb-6 font-inter">
